from anp import ANPWebScrap,captchaSolver,Excel
import time
import pysnooper
                ...
                for row in rows:
                    ...
                    if lines >= 4:
                        ...
                        try:
                            ...
                            precoRegiao['D'+str(linhas-1)] = str(colunas[1])
                            precoRegiao['E'+str(linhas-1)] = str(colunas[2])
                            precoRegiao['F'+str(linhas-1)] = str(colunas[3])
                            precoRegiao['G'+str(linhas-1)] = str(colunas[4])
                            precoRegiao['H'+str(linhas-1)] = str(colunas[5])
                            precoRegiao['I'+str(linhas-1)] = str(colunas[6])
                            precoRegiao['J'+str(linhas-1)] = str(colunas[7])
                            precoRegiao['K'+str(linhas-1)] = str(colunas[8])
                            precoRegiao['L'+str(linhas-1)] = str(colunas[9])
                            precoRegiao['M'+str(linhas-1)] = str(colunas[10])
                        except:
                            pass
                        ...
                        for linha2 in linhasTabelas:
                            ...
                            if lines1 >=2: 
                                ...
                                try:       
                                    ...
                                    precoPostos['H'+str(linhas2-1)] = str(colunas1[4])
                                    precoPostos['I'+str(linhas2-1)] = str(colunas1[5])
